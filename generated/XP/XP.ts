...
export class XP__createProjectInput_inputActionsStruct extends ethereum.Tuple {
  get name(): string {
    return this[0].toString();
  }
...
export class XP extends ethereum.SmartContract {
  ...
  createProject(
    _projectId: Bytes,
    _name: string,
    _inputActions: Array<XP__createProjectInput_inputActionsStruct>,
    _owners: Array<Address>,
    _updaters: Array<Address>
  ): Bytes {
    let result = super.call(
      "createProject",
      "createProject(bytes32,string,(string,uint256,uint8,bool)[],address[],address[]):(bytes32)",
      [
        ethereum.Value.fromFixedBytes(_projectId),
        ethereum.Value.fromString(_name),
        ethereum.Value.fromTupleArray(_inputActions),
        ethereum.Value.fromAddressArray(_owners),
        ethereum.Value.fromAddressArray(_updaters)
      ]
    );
  ...
  getScoreTypesFromScoreboard(
    _projectId: Bytes,
    _targetWallet: Address
  ): Array<string> {
    let result = super.call(
      "getScoreTypesFromScoreboard",
      "getScoreTypesFromScoreboard(bytes32,address):(string[])",
      [
        ethereum.Value.fromFixedBytes(_projectId),
        ethereum.Value.fromAddress(_targetWallet)
      ]
  ...
  try_getScoreTypesFromScoreboard(
    _projectId: Bytes,
    _targetWallet: Address
